    ...
    <div>
      ...
      <div className="flex flex-col px-6 md:w-4/5 my-12 m-auto">
        ...
        <div className="info md:my-20 my-10 md:w-1/2">
          <div className="font-bold text-2xl">YouTube Videos</div>
          <section>
            <div className="my-4 text-md">2021-2022</div>
            <p className="my-2 font-sans">
              I have been conducting a lecture series on YouTube targeted toward
              JEE/NET/JAM/JEST aspirants. In this lecture series, I have discussed
              problems of thermal physics, which appeared in previous year’s
              examinations; and I have also taught the relevant topics. I think
              these lectures will be very beneficial to the students.
            </p>
          </section>

          <section>
            <div className="my-8 italic text-xl font-medium text-gray-500">
            ...
            <div className="p-5 items-center bg-red-100 rounded-md flex flex-row space-x-3">
              ...
              <p>Find the full lecture playlist on </p>
              <Link
                target="_blank"
                href="https://www.youtube.com/@bhaveshgupta2760"
                className="hover:bg-red-600 text-red-600 hover:text-white p-1 italic rounded-md"
              >
                Youtube
              </Link>
            </div>
          ...
          <section>
            ...
            <div className="p-5 bg-blue-100 rounded-md flex flex-row space-x-3 items-center">
              ...
              <Link
                ...
                className="hover:bg-blue-600 text-blue-600 hover:text-white p-1 italic rounded-md"
              >
                Google Drive
              </Link>
            </div>
            ...
            return (
              <section>
                ...
                {e.teaching.map((element) => {
                  return (
                    <ul className="list-disc list-inside space-y-4 md:p-3 mt-6">
                      <li>
                        Teaching Assitant in <strong>{element.title}</strong>
                      </li>
                      <p>
                        <ins>
                          <em>Instructors</em>
