      ...
      <div className="flex flex-col px-6 md:w-4/5 my-12 m-auto">
        ...
        <div className="info md:mt-20 mt-10">
          <div className="address md:px-8 px-3 space-y-5">
            ...
            <div className="email">
              <strong>Address</strong> - 617, Sindhu Tower Hostel, IIT Madras, India - 600036
            </div>
          </div>
          <section className="text-gray-600 body-font relative mt-16">
            <div className="container px-5 mx-auto flex sm:flex-nowrap flex-wrap">
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d2449.113929857144!2d80.23104659883971!3d12.989363647884108!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a525d8002066921%3A0x72ac64139aeaf118!2sDepartment%20Of%20Physics%2C%20Indian%20Institute%20Of%20Technology%20Madras!5e0!3m2!1sen!2sin!4v1672140539558!5m2!1sen!2sin" width="600" height="450" style={{"border":0}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
              </div>
              <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                ...
                <button className="cursor-not-allowed text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">
                  Submit
                </button>
