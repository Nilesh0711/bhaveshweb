  ...
  return (
    <div>
      ...
      <main id="main-content" className="relative grow">
        <article className="flex md:flex-row flex-col justify-center text-center my-5">
          ...
          <section className="md:ml-32 dark:prose-invert flex flex-col items-center justify-center md:mb-20 mx-5 w-2/5">
            <h2
            ...
            <p className="mt-6">
              I am Bhavesh Gupta, a research scholar in the Physics Department
              at IIT Madras. See my about page for more information. Visit my
